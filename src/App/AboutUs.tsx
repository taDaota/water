  ...
  return (
    <div className="about-us">
      <div className="container">
        ...
        <p><a href="https://www.city.kyoto.lg.jp/bunshi/page/0000321558.html" target="_blank" rel="noreferrer">京都市文化財マネージャー育成講座</a>とは、歴史的建造物の調査や保存・活用とそれを生かしたまちづくりについて、講義と演習、修了課題で実践的に学ぶ講座です。</p>
