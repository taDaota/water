    ...
    <div className="about-us">
      <div className="container">
        ...
        <section id="culturalEducation">
          ...
          <p>歴史的建造物の調査や保存・活用とそれを生かしたまちづくりを、講義と演習、修了課題で実践的に学ぶ講座です。修了者は、京都市文化財マネージャー等へ登録することができます。</p>
          <p>2024年度で14期生として36名を迎えました。</p>
          <p>同講座は京都市に拠点を置く認定NPO法人《古材文化の会》が主催しています。</p>
          <h3>古材文化の会</h3>
