    ...
    <div className="about-us">
      <div className="container">
        ...
        <section id="directions">
          ...
          <li> 湧き水紹介のページ下部の「位置情報をオンにして道順を確認」をタップ → Google Mapsで経路検索します</li>
          </ol>
        </section>
        <section id="currentLocation">
          ...
          <p className="warning-text"><br/>※2で【次回または共有時に確認】を選択すると「⛯」アイコンをタップしても【許可】のポップアップが出ないことがあります。その場合はアプリを再度立ち上げ直してください。</p>
        </section>
        <section id="appUsage">
          <h3>アプリのように使う</h3>
          <ol>
