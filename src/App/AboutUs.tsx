    ...
    <div className="about-us">
      <div className="container">
        ...
        <div id="branding" className="branding">
          ...
          <br/>
          <p style={{ textAlign: 'left' }}>誰でも汲める京都市の湧き水を紹介するウェブアプリです。各湧き水処に決まり事があるので、ルールに従ってお水を頂きましょう。<br/></p>
          <p style={{ textAlign: 'left' }}><br/>※このマップは古材文化の会が主宰する「京都市文化財マネージャー育成講座」の課題の一環として作成されました。</p>
        </div>
        
        <section id="directions">
          <h3>道順の確認方法</h3>
          <ol>
            <li>スマホの【設定】アプリを開く<br/></li>
            <li>【プライバシーとセキュリティ】タップ<br/></li>
            <li>【位置情報サービス】をオンにする<br/></li>
        ...
        <section id="currentLocation">
          ...
          <ol>
            ...
            <li>位置情報を使用するポップアップ画面が出れば【許可】を選択 → MAPで現在位置が表示される<br/></li>
          </ol>
          <p className="warning-text"><br/>※2で【次回または共有時に確認】を選択すると「⛯」アイコンをタップしても【許可】のポップアップが出ないことがあります。その場合はアプリを立ち上げ直して、再度「⛯」アイコンをタップして下さい。</p>
        </section>
        <section id="appUsage">
          <h3>アプリのように使う</h3>
          <ol>
            <li>マップをデフォルトのブラウザで開く<br/></li>
            <li>【共有マーク】をタップ(SafariとChrome、Edgeでは三本線「≡」から共有マークを選択)<br/></li>
