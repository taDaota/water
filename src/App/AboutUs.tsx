  ...
  return (
    <div className="about-us">
      <div className="container">
        ...
        <p>このウェブアプリは誰でも汲める京都市内の湧き水を紹介するマップです。Google Mapsと連携すると経路検索機能が使えます。</p>
        <h3>注意点</h3>
        ...
        <p>歴史的建造物の調査や保存・活用とそれを生かしたまちづくりについて、講義と演習、修了課題で実践的に学ぶ講座です。2024年度は14期生として36名を迎えました。</p>
        <h3><a href="http://www.kozai.or.jp/" target="_blank" rel="noopener noreferrer">古材文化の会</a></h3>
        <p>同講座は京都市に拠点を置く認定NPO法人《古材文化の会》が主催しています。古材文化の会は日本の伝統的な建築様式で使用される古材の保存、活用、普及を目的としています。</p>
