  ...
  return (
    <div className="about-us">
      <div className="container">
        ...
        <p><a href="https://www.city.kyoto.lg.jp/bunshi/page/0000321558.html" target='_blank' rel="noreferrer"></a></p>
        
        <h2>古材文化の会</h2>
        <p>日本の伝統的な建築様式で使用される古材の保存、活用、普及を目的としています。</p>
        <p><a href="http://www.kozai.or.jp/" target='_blank' rel="noreferrer">http://www.kozai.or.jp/</a></p>
